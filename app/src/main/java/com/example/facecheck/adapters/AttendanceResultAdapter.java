...
public class AttendanceResultAdapter extends RecyclerView.Adapter<AttendanceResultAdapter.ViewHolder> {
    ...
    public void setHideScores(boolean hideScores) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(AttendanceResult result, boolean hideScores) {
            ...
            if (hideScores) {
                ...
                tvDecidedBy.setVisibility(View.GONE);
                tvScore.setTextColor(defaultScoreColor);
            } else {
                tvScore.setVisibility(View.VISIBLE);
                tvDecidedBy.setVisibility(View.VISIBLE);
            ...
            if (adapter != null && adapter.failuresMode) {
                itemView.setScaleX(0.90f);
                itemView.setScaleY(0.90f);
